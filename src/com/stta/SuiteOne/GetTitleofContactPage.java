...
public class GetTitleofContactPage extends SuiteOneBase{
	...
	public void getTitleofContactPage()
	{
		//To Initialize Firefox browser.
				...
				getElementByXPath("menu_xpath").click();
				getElementByXPath("contact_xpath").click();
				driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
				String sActualResult = driver.getTitle();
				String sExpectedResult = "Quovantis Technologies – Contact Details of Offices";
